...
//-- Helpers -----------------------------------------------------------------------------------------------------------
func shutdownService(test *testing.T, service Service) {
...
//-- Tests -------------------------------------------------------------------------------------------------------------
func TestServiceNewService(test *testing.T) {
	//-- Shared Variables ----------
	var store Store
	var service Service
...
func TestServiceNewServiceWithMiddleware(test *testing.T) {
	//-- Shared Variables ----------
	var store Store
	...
	logger = NewLogMiddleare(*log.New(os.Stdout, `task_service: `, 3))
...
func TestServiceCreate(test *testing.T) {
	//-- Shared Variables ----------
...
func TestServiceCreateErr(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var model *Task
	var store Store
...
func TestServiceUpdate(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
...
func TestServiceUpdateErr(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var model *Task
	var store Store
...
func TestServiceRead(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
...
func TestServiceReadErr(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var model, readModel *Task
	var store Store
...
func TestServiceDelete(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
...
func TestServiceDeleteErr(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var model, deleteModel *Task
	var store Store
...
func TestServiceList(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var store Store
	var service Service
...
func TestServiceListLimit(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var store Store
	var service Service
...
func TestServiceListZeroLimit(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var store Store
	var service Service
...
func TestServiceListOverLimit(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var store Store
	var service Service
...
func TestServiceListOffset(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var store Store
	var service Service
...
func TestServiceListOverOffset(test *testing.T) {
	//-- Shared Variables ----------
	var ctx context.Context
	var store Store
	var service Service
